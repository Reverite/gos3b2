...
func b2Upload(authJson *B2AuthorizeAccountJSON, path string, body []byte, length string, cType string) (int, error) {
...
func b2UploadPart(authJson *B2AuthorizeAccountJSON, uploadId string, partNumber int, body []byte, length string, cType string) (int, error) {
